...
const productBestSellerData: Product[] = [
    {
        title: "Stik Game Havit HV-G69 USB",
        reviews: 15,
        price: 590000, // Rp 590.000
        discountedPrice: 290000, // Rp 290.000
        id: 1,
        imgs: {
            thumbnails: [
    ...
    },
    {
        ...
        reviews: 5,
        price: 8990000, // Rp 8.990.000
        discountedPrice: 990000, // Rp 990.000
        id: 2,
        imgs: {
            thumbnails: [
...
export default productBestSellerData;
